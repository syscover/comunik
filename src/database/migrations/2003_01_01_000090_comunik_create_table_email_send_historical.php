...
class ComunikCreateTableEmailSendHistorical extends Migration {
	...
	public function up()
	{
        Schema::create('005_048_email_send_historical', function(Blueprint $table){
            ...
            $table->foreign('send_queue_048', 'fk01_005_048_email_send_historical')->references('id_047')->on('005_047_email_send_queue')
                ->onDelete('set null')->onUpdate('cascade');
            $table->foreign('campaign_048', 'fk02_005_048_email_send_historical')->references('id_044')->on('005_044_email_campaign')
                ->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('contact_048', 'fk03_005_048_email_send_historical')->references('id_041')->on('005_041_contact')
                ->onDelete('cascade')->onUpdate('cascade');
        });
	}
