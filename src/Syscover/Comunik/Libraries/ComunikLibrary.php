...
class ComunikLibrary
{
    ...
    public static function createContact(Request $request)
    {
        ...
        $contact = Contact::create([
            ...
            'birth_date_041'            => $request->input('birthDate')? \DateTime::createFromFormat(config('pulsar.datePattern'), $request->input('birthDate'))->getTimestamp() : null,
            'birth_date_text_041'       => $request->input('birthDate')? $request->input('birthDate') : null,
            ...
            'unsubscribe_mobile_041'    => $request->has('subscribeMobile') && $request->input('subscribeMobile') != '1'? true : false,
            'unsubscribe_email_041'     => $request->has('subscribeEmail') && $request->input('subscribeEmail') != '1'? true : false
        ]);
