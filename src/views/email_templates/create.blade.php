...
@section('rows')
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input type="hidden" name="header" value="{{ htmlspecialchars(Input::old('header')) }}">
            <input type="hidden" name="body" value="{{ htmlspecialchars(Input::old('body')) }}">
            <input type="hidden" name="footer" value="{{ htmlspecialchars(Input::old('footer')) }}">
            <input type="hidden" name="text" value="{{ htmlspecialchars(Input::old('text')) }}">
            <input type="hidden" name="data" value="{{ htmlspecialchars(Input::old('data')) }}">
            <textarea name="wysiwyg" class="form-control limited required wysiwyg" cols="5" rows="10">{{ Input::old('body') }}</textarea>
