...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('pulsar::pulsar.group', 2), 'name' => 'groups[]', 'value' => Input::old('groups'), 'objects' => $groups, 'idSelect' => 'id_029', 'nameSelect' => 'name_029', 'multiple' => true, 'class' => 'select2', 'fieldSize' => 10, 'data' => ['placeholder' => 'Seleccione las categorías correspondientes']])
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('pulsar::pulsar.country', 1), 'name' => 'country', 'required' => false, 'idSelect' => 'id_002', 'nameSelect' => 'name_002', 'class' => 'select2', 'fieldSize' => 4])
