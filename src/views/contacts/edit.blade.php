...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans('pulsar::pulsar.birthdate'), 'name' => 'birthdate', 'value' => $object->birthdate_041? date('d-m-Y', $object->birthdate_041) : null, 'fieldSize' => 2, 'data' => ['mask' => '99-99-9999']])
